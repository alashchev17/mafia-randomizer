...
export const database: IDatabase = {
  ...
  roles: [
    ...
    },
    {
      ...
      title: "Доктор",
      roleDescription:
        "играет за команду Мирных жителей. Задача Доктора – защитить Шерифа от покушения Мафии. Каждую ночь имеет право скрытно от других игроков, выйти на ночное дежурство и спасти кому-то жизнь.",
